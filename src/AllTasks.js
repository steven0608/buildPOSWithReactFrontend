...
const AllTasks = (props) => {
  ...
  return (<ul>
    {
      props.currentUser.todolists.map(todolist => <div key={UUID()}><ToDoList todolist={todolist} name="allTasks"/>
        <button name={todolist.id} onClick={handleDeleteTask}>Delete</button>
      </div>)
    }
  </ul>)
